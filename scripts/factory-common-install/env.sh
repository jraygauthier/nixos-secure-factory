#!/usr/bin/env bash
current_pkg_root_dir_env_var_name="PKG_NSF_FACTORY_COMMON_INSTALL_PACKAGE_ROOT_DIR"
...
if ! [[ -f "$current_pkg_root_dir/bin/pkg-nsf-factory-common-install-get-root-dir" ]]; then
