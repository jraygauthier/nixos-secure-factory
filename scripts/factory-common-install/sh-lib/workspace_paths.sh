...
get_device_cfg_repo_root_dir() {
  # TODO: What occurs when `PKG_NSF_FACTORY_COMMON_INSTALL_DEVICE_OS_CONFIG_REPO_DIR`
  # does not exists? Shouldn't we take this information from `.factory-info.yaml`?
  local root_dir=${PKG_NSF_FACTORY_COMMON_INSTALL_DEVICE_OS_CONFIG_REPO_DIR?}
  # 1>&2 echo "root_dir=$root_dir"
  if ! is_device_cfg_repo_root_dir "$root_dir"; then
    1>&2 printf -- "ERROR: Env var'PKG_NSF_FACTORY_COMMON_INSTALL_DEVICE_OS_CONFIG_REPO_DIR' "
...
get_factory_install_device_type_definitions_root_dir() {
  # TODO: What occurs when `PKG_NSF_FACTORY_COMMON_INSTALL_DEVICE_TYPE_FACTORY_INSTALL_DEFS_DIR`
  # does not exists? Shouldn't we take this information from `.factory-info.yaml`?

  local root_dir=${PKG_NSF_FACTORY_COMMON_INSTALL_DEVICE_TYPE_FACTORY_INSTALL_DEFS_DIR?}
  # 1>&2 echo "root_dir=$root_dir"
  if ! is_factory_install_device_type_definitions_root_dir "$root_dir"; then
    1>&2 printf -- "ERROR: Env var 'PKG_NSF_FACTORY_COMMON_INSTALL_DEVICE_TYPE_FACTORY_INSTALL_DEFS_DIR' should "
...
get_device_cfg_type_definitions_root_dir() {
  # TODO: What occurs when `PKG_NSF_FACTORY_COMMON_INSTALL_DEVICE_CONFIG_TYPE_DEFS_DIR`
  # does not exists? Shouldn't we take this information from `.factory-info.yaml`?

  local root_dir=${PKG_NSF_FACTORY_COMMON_INSTALL_DEVICE_CONFIG_TYPE_DEFS_DIR?}
  # 1>&2 echo "root_dir=$root_dir"
  if ! is_device_cfg_type_definitions_root_dir "$root_dir"; then
    1>&2 printf -- "ERROR: Env var 'PKG_NSF_FACTORY_COMMON_INSTALL_DEVICE_CONFIG_TYPE_DEFS_DIR' should "
...
get_device_cfg_ssh_auth_root_dir() {
  ...
  local root_dir=${PKG_NSF_FACTORY_COMMON_INSTALL_DEVICE_CONFIG_SSH_AUTH_DIR?}
  # 1>&2 echo "root_dir=$root_dir"
  if ! is_device_cfg_ssh_auth_root_dir "$root_dir"; then
    1>&2 printf -- "ERROR: Env var 'PKG_NSF_FACTORY_COMMON_INSTALL_DEVICE_CONFIG_SSH_AUTH_DIR' should "
...
get_writable_device_cfg_ssh_auth_root_dir() {
  ...
  if  ! is_writable_device_cfg_ssh_auth_root_dir "$root_dir"; then
    1>&2 printf -- "ERROR: Env var'PKG_NSF_FACTORY_COMMON_INSTALL_DEVICE_CONFIG_SSH_AUTH_DIR' "
